...
export default function LoginPage() {
  ...
  return (
    <main className="relative grid min-h-screen bg-background lg:grid-cols-[minmax(0,1fr)_minmax(460px,0.72fr)]">
      <div className="absolute right-3 top-3 z-10">
        <ThemeToggle />
      </div>

      <section className="relative hidden overflow-hidden border-r bg-primary p-10 text-primary-foreground lg:flex lg:flex-col lg:justify-between xl:p-14">
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-55"
            >
